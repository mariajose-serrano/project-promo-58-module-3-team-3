  ...
  return (
    <div className="container">
      ...
      <Hero />
        ...
        <Preview cardData={cardData}/*name={name} slogan={slogan} repo={repo} demo={demo} technologies={technologies} desc={desc} author={author} job={job}*/ />
        <Form handleInputCard={handleInputCard} cardData={cardData} />
      </main>
